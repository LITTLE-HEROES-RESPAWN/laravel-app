        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white   border-b border-gray-200">
                    ...
                    <p class="mb-4 font-bold text-lg text-slate-700">削除確認</p>
                    <p class="mb-4 text-slate-700">本当に削除しますか？</p>
                    ...
                    <form class="mt-4" action="{{ route('articles.destroy', $article->id) }}" method="post">
                        @method('DELETE')
                        @csrf
